                ...
                <form class="form-group" action="#" method="POST">
                        <div class="card">
                            ...
                            <div class="card-body">
                              ...
                              <div class="row">
                                <div class="col-sm">
                                  <button type="submit" class="btn btn-primary btn-lg" name="btnCambiar">Cambiar</button>
                                </div>
                                <div class="col-sm">
                                  <button type="submit" class="btn btn-outline-warning btn-lg" name="btnLimpiar">Limpiar</button>
                                </div>
                              </div>
                            </div>
                            </div>
